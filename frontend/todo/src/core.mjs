...
const definiteFailures=new Set(['invalid_model_response','model_not_configured','invalid_model_config','model_auth_error','model_http_error','model_response_too_large','model_unavailable','model_stream_failed','import_storage_error']);
